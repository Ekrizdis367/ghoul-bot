...
client.on('message', (msg) => {
        ...
        getCompulsions().then( compulsions => {
            compulsions.forEach( compulsion => {
                if (message === '0' && compulsion.name === 'Clan Compulsion') {
                    ...
                    let collector = new Discord.MessageCollector(msg.channel, m => m.author === msg.author, 10)
                    ...
                    dice.forEach( die => {
                        if (message === die) {
                            let compulsionCard = new Discord.MessageEmbed()
                                ...
                                .setFooter("Corebook, " + compulsion.page);
    ...
    if (msg.content === '!ghoul') {
        let card = new Discord.MessageEmbed()
            ...
            .setThumbnail(vtmSymbol)
            .setFooter('The Ghoul, a Discord Bot created by Ekrizdis#3957');
