...
client.on('message', (msg) => {
    ...
    if (msg.content === '!ghoulcount' && msg.author.id === '214120712678408194') {
        let bots = 0;
        client.guilds.cache.forEach( guild => { bots++ });
        msg.channel.send('The Ghoul is connected to **' + bots + '** servers!');
    }
